...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
        ...
        function PrismaService_1() {
            ...
            var maskedUrl = databaseUrl.replace(/:[^:@]+@/, ':****@');
            ...
            _this.$on('error', function (e) {
                _this.logger.error('Database error:', (e === null || e === void 0 ? void 0 : e.message) || e);
                if (e === null || e === void 0 ? void 0 : e.meta) {
                    _this.logger.error('Error details:', e.meta);
                }
            });
            return _this;
        }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            ...
                            this.logger.error("Error: ".concat(queryError_1.message));
                            return [3 /*break*/, 5];
                        case 5: return [3 /*break*/, 7];
                        case 6:
                            error_1 = _a.sent();
                            this.logger.error('❌ Database connection failed');
                            this.logger.error("Error details: ".concat(error_1.message));
                            this.logger.error("Stack trace:", error_1.stack);
                            this.logger.error("DATABASE_URL: ".concat(process.env.DATABASE_URL ? 'SET' : 'NOT SET'));
                            throw error_1;
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            error_2 = _a.sent();
                            this.logger.error('❌ Error disconnecting database:', error_2);
                            return [3 /*break*/, 4];
