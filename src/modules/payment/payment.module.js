...
var payme_service_1 = require("./services/payme.service");
var payment_controller_1 = require("./payment.controller");
var premium_guard_1 = require("./guards/premium.guard");
var prisma_module_1 = require("../../prisma/prisma.module");
var grammy_bot_module_1 = require("../../common/grammy/grammy-bot.module");
var PaymentModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [prisma_module_1.PrismaModule, config_1.ConfigModule, grammy_bot_module_1.GrammyBotModule],
            controllers: [payment_controller_1.PaymentController],
            providers: [payment_service_1.PaymentService, premium_service_1.PremiumService, payme_service_1.PaymeService, premium_guard_1.PremiumGuard],
            exports: [payment_service_1.PaymentService, premium_service_1.PremiumService, payme_service_1.PaymeService, premium_guard_1.PremiumGuard],
        })];
