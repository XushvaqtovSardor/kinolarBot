...
exports.AdminHandlersModule = void 0;
var common_1 = require("@nestjs/common");
var admin_handler_1 = require("./admin.handler");
...
var AdminHandlersModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            ...
            providers: [admin_handler_1.AdminHandler],
            exports: [admin_handler_1.AdminHandler],
        })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var AdminHandlersModule = _classThis = /** @class */ (function () {
        function AdminHandlersModule_1() {
        }
        return AdminHandlersModule_1;
    }());
    __setFunctionName(_classThis, "AdminHandlersModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        AdminHandlersModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AdminHandlersModule = _classThis;
}();
exports.AdminHandlersModule = AdminHandlersModule;
